...
// Copyright (c) 2014 The Heirloom developers
...
// for both SuperTurbostaked and Heirloom(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of Heirloom releases, the client name should be selected from
