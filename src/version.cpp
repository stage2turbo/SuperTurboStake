...
// Copyright (c) 2014 The SuperTurbostake developers
...
// for both SuperTurbostaked and SuperTurbostake(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of SuperTurbostake releases, the client name should be selected from
